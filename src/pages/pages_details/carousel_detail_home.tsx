      ...
      <>
        ...
        <section className="min-h-screen bg-[#f7f7f7] flex items-center justify-center px-4">
          <div className="text-center space-y-4">
            ...
            <button
              onClick={() => navigate("/")}
              className="bg-[#ddc588] text-white px-6 py-3 rounded-full font-semibold hover:bg-[#c5ae77] transition-all"
            >
              Back to Home
            </button>
          </div>
      ...
      <section className="bg-[#f7f7f7] min-h-screen pb-16">
        <div className="relative h-[55vh] md:h-[65vh] overflow-hidden">
          ...
          <div className="absolute bottom-10 left-1/2 -translate-x-1/2 w-full px-6 md:px-10 max-w-4xl text-white">
            <button
              onClick={() => navigate("/")}
              className="flex items-center gap-2 mb-4 hover:text-[#ddc588] transition-all group"
            >
              <ArrowLeft
                size={20}
        ...
        <section className="px-6 md:px-10 lg:px-20 mt-20 mb-24">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-[1.8rem] md:text-[2.2rem] font-bold text-[#111111] mb-6">
