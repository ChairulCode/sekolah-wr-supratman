...
import "./css/kegiatan-detail.css";
...
const ActivityDetail = () => {
	...
	const [data, setData] = useState<ActivityDetailResponse["data"] | null>(null);
	...
	useEffect(() => {
		const getData = async () => {
			try {
				const response = await getRequest(`kegiatan/${id}`);
		...
		<>
			...
			<div className='activity-detail-wrapper'>
				<div className='activity-detail-container'>
					...
					<div className='activity-detail-content'>
						...
						<div className='detail-info'>
							...
							<div className='activity-image'>
								<img src={`${BASE_URL}/${data.path_gambar}`} alt={data.judul} className='announcement-img' />
							</div>
							...
							<div className='detail-content'>
								<p className='detail-text'>{data.deskripsi}</p>
							</div>
					...
					<div className='other-activity-nav'>
