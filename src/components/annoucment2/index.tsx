		...
		<>
			<div className='ann-wrapper'>
				...
				<div className='ann-hero' data-aos='fade-down'>
					...
					<p className='ann-hero-desc'>Informasi penting dan update terkini untuk seluruh siswa dan guru</p>
					...
					<div className='ann-modal-overlay' onClick={() => setSelectedAnnouncement(null)}>
						<div className='ann-modal' onClick={(e) => e.stopPropagation()}>
							...
							<div className='ann-modal-header'>
								...
								<button className='ann-modal-close' onClick={() => setSelectedAnnouncement(null)}>
									<X size={24} />
								</button>
							</div>
							...
							<div className='ann-modal-meta'>
								<div className='ann-modal-meta-item'>
									...
									<div>
										...
										<span className='ann-modal-meta-value'>{formatTime(selectedAnnouncement.tanggal_publikasi, "DD MMMM yyyy")}</span>
									</div>
								</div>
							</div>
							...
							<div className='ann-modal-footer'>
								<button className='ann-modal-btn' onClick={() => setSelectedAnnouncement(null)}>
									Saya Mengerti
								</button>
							</div>
						</div>
