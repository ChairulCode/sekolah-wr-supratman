...
import "./css/prestasi-detail.css";
...
const PrestasiDetail = () => {
  ...
  const prestasi = announcements.find((item) => item.id === Number(id));
        ...
        <div className="prestasi-detail-container">
          ...
          <div className="prestasi-detail-content">
            ...
            <div className="detail-info">
              ...
              {/* Title */}
              <h1 className="detail-title">{prestasi.title}</h1>
              ...
              <div className="detail-content">
                <p className="detail-text">{prestasi.content}</p>
              </div>
